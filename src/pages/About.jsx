            ...
            <section className='bg-richblack-700'>
                <div className='relative mx-auto flex w-10/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
                    <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">
                        ...
                        <HighlightText1 text={"Brighter Future"} background={"bg-gradient-to-b from-[#5AB2FF] to-[#8CFFD6]"} />
                ...
                <div className="mx-auto flex w-10/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
                    <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
                        <div className="my-24 flex lg:w-[50%] flex-col gap-10">
                            <div className='text-4xl font-semibold text-transparent lg:w-[70%] '>
                                <HighlightText1 text={"Our Founding Story"} background={"bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045]"} />
                            </div>
                    ...
                    <div className="flex flex-col items-center lg:gap-10 lg:flex-row justify-between">
                        <div className="my-24 flex lg:w-[40%] flex-col gap-10">
                            <div className='text-4xl font-semibold lg:w-[70%] '>
                                <HighlightText1 text={"Our Vision"} background={"bg-gradient-to-b from-[#FF512F] to-[#F09819]"} />
                            </div>
                            <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
                        ...
                        <div className="my-24 flex lg:w-[40%] flex-col gap-10">
                            <div className='text-4xl font-semibold lg:w-[70%] '>
                                <HighlightText1 text={"Our Mission"} background={"bg-gradient-to-b from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB]"} />
                            </div>
                            <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
